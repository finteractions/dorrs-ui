...
class SymbolService extends BaseService {
    ...
    public async getSymbols(): Promise<Array<ISymbol>> {
        return (await apiWebBackendService.get<IResponse<Array<ISymbol>>>(`${this.PATH}user_list/`, {}, this.getUserAccessToken())).data;
    }

    public createSymbol(data: any): Promise<any> {
        return apiWebBackendService.post(`${this.PATH}user_list/`, data, {}, this.getUserAccessToken())
    }

    public updateSymbol(data: any, id: number): Promise<any> {
        return apiWebBackendService.put(`${this.PATH}user_list/${id}/`, data, {}, this.getUserAccessToken());
    }
