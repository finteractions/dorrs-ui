...
class UserBlock extends React.Component<UserBlockProps, UserBlockState> {
    ...
    getUser = (user_id: string) => {
        adminService.getUser(user_id || '')
            ...
            .catch((errors: IError) => {
                this.setState({errorMessages: errors.messages, loading: false, data: null, isConfirmedApproving: false, isActivation: null, isConfirmedActivation: false });
            })
    }
                                                    ...
                                                    <div className="view-form-box">
                                                        ...
                                                        <div className="box__wrap">
                                                            {this.state.data?.identity_verification && (
                                                                <a className="link" target='_blank' href={this.state.data?.identity_verification || ''}>{<FontAwesomeIcon
                                                                    className="nav-icon"
                                                    ...
                                                    <div className="view-form-box">
                                                        ...
                                                        <div className="box__wrap">
                                                            {this.state.data?.sign_dmcc_agreement && (
                                                                <a className="link" target='_blank' href={this.state.data?.sign_dmcc_agreement || ''}>{<FontAwesomeIcon
                                                                    className="nav-icon"
